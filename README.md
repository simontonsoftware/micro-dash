...
- Small payload size. This full package is `3,674 bytes` minified, while a bundle containing the corresponding lodash functions is `39,002 bytes`. Size comparisons when importing individual functions are provided in their documentation.
